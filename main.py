...
LABELS["اطلاعیه_ماده103"] = (
    ...
    "برای تکمیل این صورتجلسه، لازم است ابتدا {سند} را در یکی از دفاتر اسناد رسمی تنظیم کرده باشید؛ زیرا درج مشخصات آن در متن صورتجلسه الزامی است. ✍️🧾"
)
