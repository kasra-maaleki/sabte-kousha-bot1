    ...
    try:
        ...
        if data.get("ai_mode") == "name_suggestion":
            ...
            if step == 2:
                ...
                user_prompt = (
                    f"پنج نام پیشنهادی سه‌سیلابی برای شرکت بساز که در آن از کلمه‌ی '{data['کلمه اصلی']}' استفاده شده باشد "
                ...
                system_prompt = (
                    ...
                    "نام‌های پیشنهادی باید فارسی و حرفه‌ای باشند، از ترکیب کلمه‌ی کاربر با مفاهیم مرتبط با حوزه‌ی فعالیت."
                )
